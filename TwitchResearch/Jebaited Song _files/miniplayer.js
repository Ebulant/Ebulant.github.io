...
g.k.bD=function(){this.tooltip=new g.SQ(this.player,this);g.F(this,this.tooltip);g.hN(this.player,this.tooltip.element,4);this.tooltip.scale=.6;this.lc=new g.oO(this.player);g.F(this,this.lc);this.rg=new g.V({D:"div",K:"ytp-miniplayer-scrim"});g.F(this,this.rg);this.rg.Ba(this.element);this.N(this.rg.element,"click",this.Sy);var a=new g.V({D:"button",Ea:["ytp-miniplayer-close-button","ytp-button"],U:{"aria-label":"Close"},S:[g.vL()]});g.F(this,a);a.Ba(this.rg.element);this.N(a.element,"click",this.wi);
...
Ea:["ytp-miniplayer-close-button","ytp-button"],U:{"aria-label":"Close"},S:[g.vL()]});g.F(this,a);a.Ba(this.Gy.element);this.N(a.element,"click",this.wi);a=new g.V({D:"button",Ea:["ytp-miniplayer-replay-button","ytp-button"],U:{"aria-label":"Close"},S:[g.AL()]});g.F(this,a);a.Ba(this.Gy.element);this.N(a.element,"click",this.UT);this.N(this.player,"presentingplayerstatechange",this.Gc);this.N(this.player,"appresize",this.tb);this.N(this.player,"fullscreentoggled",this.tb);this.tb()};
